...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public FileOperationsUtil(ILogger<FileOperationsUtil> logger, IConfiguration configuration, IGitUtil gitUtil, IDotnetUtil dotnetUtil, IProcessUtil processUtil, 
        IFileDownloadUtil fileDownloadUtil, IFileUtil fileUtil, IDirectoryUtil directoryUtil, IOpenApiFixer openApiFixer, IPostmanConverter postmanConverter, IKiotaUtil kiotaUtil)
    {
        _logger = logger;
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        await _kiotaUtil.Generate(fixedFilePath, "FastlyOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
